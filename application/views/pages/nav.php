                            ...
                            if ($this->session->userdata['logged_in']['user_type_id'] == '1') {
                                ...
                                ?>
                                    <li><a href="<?php echo site_url('welcome/crimehead'); ?>"
                                            Style="font-size:16px">Crime Head</a></li><?php }?>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="submenu">
                                    <li><a href="<?php echo site_url('welcome/arrest_entry'); ?>"
                                            Style="font-size:16px">New Arrest</a></li>
                                    <li><a href="<?php echo site_url('welcome/victim_entry'); ?>"
                                            Style="font-size:16px">Victim</a></li>
                                    <li><a href="<?php echo site_url('welcome/edit_seizure'); ?>"
                                            Style="font-size:16px">Add/Edit Seizure</a></li>
                                    <li><a href="<?php echo site_url('welcome/edit_ud'); ?>" Style="font-size:16px">Add/Edit UD</a></li>
                                    <li><a href="<?php echo site_url('welcome/rta_page'); ?>" Style="font-size:16px">Add/Edit RTA</a>
                                    </li>
                                </ul>
                            </li>
                            <li><a href="#"><i Style="font-size:17px" class="fa fa-file "></i><span>Report</span></a>
                                <ul class="submenu">
